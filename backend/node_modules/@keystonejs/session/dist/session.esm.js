...
class SessionManager {
  constructor({
    ...
    _defineProperty(this, "_cookieSecret", void 0);

    _defineProperty(this, "_cookie", void 0);

    _defineProperty(this, "_sessionStore", void 0);
  ...
  getSessionMiddleware({
    ...
    const injectAuthCookieMiddleware = (req, res, next) => {
      ...
      const cookies = cookie.parse(req.headers.cookie || ''); // Construct a "fake" session cookie based on the authorization token
