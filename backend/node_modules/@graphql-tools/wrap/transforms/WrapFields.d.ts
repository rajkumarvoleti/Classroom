...
export default class WrapFields<TContext> implements Transform<WrapFieldsTransformationContext, TContext> {
    ...
    transformRequest(originalRequest: ExecutionRequest, delegationContext: DelegationContext, transformationContext: WrapFieldsTransformationContext): ExecutionRequest;
