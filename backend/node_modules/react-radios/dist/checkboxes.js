...
var CheckboxContainer = function (_Container) {
  _inherits(CheckboxContainer, _Container);
  ...
  function CheckboxContainer(props) {
    ...
    _this.onChange = function (event) {
      ...
      if (_this.state.value.includes(val)) {
        value = _this.state.value.filter(function (c) {
          return c !== val;
        });
      } else {
        value.push(val);
    ...
    _this.name = props.name || 'checkbox-group-' + instanceCounter++;
...
var CheckboxGroup = exports.CheckboxGroup = function (_Component) {
  ...
  function CheckboxGroup() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref = CheckboxGroup.__proto__ || Object.getPrototypeOf(CheckboxGroup)).call.apply(_ref, [this].concat(args))), _this2), _this2.container = new CheckboxContainer(_this2.props), _temp), _possibleConstructorReturn(_this2, _ret);
  }
...
var Checkbox = exports.Checkbox = function (_Component2) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        function (_ref2) {
          ...
          var checked = state.value.includes(props.value);
