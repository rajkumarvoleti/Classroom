...
export interface DayPickerProps extends DayPickerComponentProps {
    ...
    enableOutsideDaysClick: NonNullable<DayPickerComponentProps['enableOutsideDaysClick']>;
    ...
    modifiersClassNames: NonNullable<DayPickerComponentProps['modifiersClassNames']>;
